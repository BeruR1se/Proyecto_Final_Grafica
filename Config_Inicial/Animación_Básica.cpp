...
// Variables de animación del columpio
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion basica Maria Jose Vaca Lara", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// === ASIENTO (parte móvil) ===
		//glm::mat4 model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-4.5f, 0.7f, -4.65f)); // <-- movemos en X=3.0 para alinear con los lados
		...
		modelLado = glm::translate(modelLado, glm::vec3(3.0f, 0.5f, -0.25f));
		...
		modelLado = glm::translate(modelLado, glm::vec3(3.0f, 0.5f, -0.65f));
		modelLado = glm::scale(modelLado, glm::vec3(2.0f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelLado));
