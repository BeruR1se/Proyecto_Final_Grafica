...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica_10 Alvarez Lugo Victor Manuel", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, transDogY, 0.0f)); //Ubicamos el perro en sus respectiva trayectoria
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(0.0f, transBallY, 0.0f));//Ubicamos la pelota en su respectiva trayectoria
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
